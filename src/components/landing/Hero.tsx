    ...
    <section className="py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center px-6 relative z-10">
        <div className="space-y-6 text-center md:text-left">
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter leading-tight">Blockchain For Everyone</h2>
          <p className="text-lg text-muted-foreground max-w-xl mx-auto md:mx-0">
            Omchain is a scalable and robust blockchain, built to satisfy the near real-time EVM need of everyone.
          </p>
        ...
        <div className="relative group aspect-square">
          ...
          <Image 
            ...
            data-ai-hint="abstract blockchain network"
            width={800}
            height={800}
